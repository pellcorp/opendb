...
$input_type_functions = array('hidden' => array('args' => array(), 'description' => 'A hidden input field.  Hidden fields are often used for site plugin link attributes.'), 'readonly' => array('args' => array(), 'description' => 'A readonly field'),
		'text' => array('args' => array('length[Y]', 'maxlength'), 'description' => 'A text field'), 'textarea' => array('args' => array('cols[Y]', 'rows[Y]'), 'description' => 'A textarea field'), 'htmlarea' => array('args' => array('cols[Y]', 'rows[Y]'), 'description' => 'A HTML textarea field'),
		'email' => array('args' => array('length[Y]', 'maxlength'), 'description' => 'A text field with email format validation'), 'filtered' => array('args' => array('length[Y]', 'maxlength', 'legalchars[Y]'), 'description' => 'A text field with validation controlled by legalchars parameter.'),
