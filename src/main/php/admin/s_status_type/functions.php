...
function insert_s_status_type($s_status_type, $description, $img, $delete_ind, $change_owner_ind, $borrow_ind, $status_comment_ind, $hidden_ind, $default_ind) {
	...
	if ($insert && $rows_affected !== -1) {
		if ($rows_affected > 0) {
			opendb_logger(OPENDB_LOG_INFO, __FILE__, __FUNCTION__, db_error(), array($s_status_type, $description, $img, $delete_ind, $change_owner_ind, $borrow_ind, $status_comment_ind, $hidden_ind, $default_ind));
		}
		return TRUE;
	} else {
		opendb_logger(OPENDB_LOG_ERROR, __FILE__, __FUNCTION__, db_error(), array($s_status_type, $description, $img, $delete_ind, $change_owner_ind, $borrow_ind, $status_comment_ind, $hidden_ind, $default_ind));
		return FALSE;
	}
}
...
function update_s_status_type($s_status_type, $description, $img, $delete_ind, $change_owner_ind, $borrow_ind, $status_comment_ind, $hidden_ind, $default_ind, $closed_ind) {
	...
	$query = "UPDATE s_status_type " . "SET description = '$description', " . "img = '$img', " . "delete_ind = '$delete_ind', " . "change_owner_ind = '$change_owner_ind', " . "borrow_ind = '$borrow_ind', " . "status_comment_ind = '$status_comment_ind', " . "default_ind = '$default_ind', "
			. "closed_ind = '$closed_ind', " . "hidden_ind = '$hidden_ind'" . " WHERE s_status_type = '$s_status_type'";
