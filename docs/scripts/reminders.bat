...
lynx -accept_all_cookies -dump -dont_wrap_pre "%OPENDB_URL%/login.php?op=login&uid=%OPENDB_ADMIN_UID%&passwd=%OPENDB_ADMIN_PWD%&redirect=item_borrow.php?op%3Dadmin_send_reminders%26mode%3Djob" > %LOGFILE%
