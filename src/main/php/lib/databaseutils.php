...
function fetch_opendb_table_list_r() {
	$tables = array('s_item_type', 's_item_type_group', 's_item_type_group_rltshp', 's_attribute_type', 's_attribute_type_lookup', 's_item_attribute_type', 's_status_type', 's_address_type', 's_addr_attribute_type_rltshp', 's_site_plugin', 's_site_plugin_conf', 's_site_plugin_input_field',
			's_site_plugin_s_attribute_type_map', 's_site_plugin_s_attribute_type_lookup_map', 's_site_plugin_link', 's_config_group', 's_config_group_item', 's_config_group_item_var', 's_title_display_mask', 's_title_display_mask_item', 's_item_listing_conf', 's_item_listing_column_conf', 'user',
			'user_address', 'user_address_attribute', 'review', 'item', 'item_instance', 'item_attribute', 'borrowed_item', 'announcement', 'import_cache', 'file_cache', 'php_session', 's_file_type_content_group', 's_file_type', 's_file_type_extension', 's_language', 's_language_var',
			's_table_language_var', 's_opendb_release', 'item_instance_relationship', 'mailbox', 's_role', 's_permission', 's_role_permission');
