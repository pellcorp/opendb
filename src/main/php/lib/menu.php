...
function get_menu_section_title($section) {
	$section_vars = array('items' => get_opendb_lang_var('items'), 'listings' => get_opendb_lang_var('listings'), 'borrow' => get_opendb_lang_var('borrow'), 'search' => get_opendb_lang_var('search'), 'stats' => get_opendb_lang_var('statistics'), 'feeds' => get_opendb_lang_var('feeds'),
			'users' => get_opendb_lang_var('users'), 'admin_tools' => get_opendb_lang_var('admin_tools'));
