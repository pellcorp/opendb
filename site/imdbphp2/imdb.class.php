<?php
 ...
 /* $Id: imdb.class.php 538 2013-02-06 08:00:27Z izzy $ */
  ...
  * @version $Revision: 538 $ $Date: 2013-02-06 19:00:27 +1100 (Wed, 06 Feb 2013) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 538 $');
    $this->setid($id);
  }
