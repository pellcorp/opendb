...
class WidgetsTest extends PHPUnit_Framework_TestCase {
	...
	function testNumberRangeExpand() {
		$this->assertEquals("0123456789", expand_chars_exp("0-9"));
	}
	...
	function testAlphaNumericFormat() {
		$this->assertEquals("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_.", expand_chars_exp("a-zA-Z0-9_."));
	}
