...
function get_s_item_listing_column_conf_rs($s_item_type_group, $s_item_type) {
	...
	if (is_exists_s_item_listing_column_conf($silc_id)) {
		...
		return array(array(column_type => 's_field_type', s_field_type => 'TITLE'), array(column_type => 'action_links'), array(column_type => 's_field_type', s_field_type => 'OWNER'), array(column_type => 's_field_type', s_field_type => 'STATUSTYPE'),
