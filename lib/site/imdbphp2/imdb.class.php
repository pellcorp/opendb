<?php
 ...
 /* $Id: imdb.class.php 613 2013-10-14 20:30:12Z izzy $ */
  ...
  * @version $Revision: 613 $ $Date: 2013-10-14 22:30:12 +0200 (Mon, 14 Oct 2013) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 613 $');
    $this->setid($id);
  }
