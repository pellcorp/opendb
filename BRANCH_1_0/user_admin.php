...
function get_user_input_form($user_r, $HTTP_VARS)
{
	...
	{
		$buffer .= format_help_block(array(array('img'=>'compulsory.gif', 'text'=>get_opendb_lang_var('compulsory_field'))));
	}
	...
	if($HTTP_VARS['op'] == 'new_user')
	{
		...
		{
			$buffer .= format_help_block(array(array('text'=>get_opendb_lang_var('new_passwd_will_be_autogenerated_if_not_specified'))));
		}
	}//if($HTTP_VARS['op'] == 'new_user')
