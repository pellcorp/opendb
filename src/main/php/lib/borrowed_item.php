...
function get_orderby_clause($order_by, $sortorder) {
	if ($order_by === "s_item_type")
		...
		return "ORDER BY bi.update_on $sortorder";
	//no order by!
	else
...
function fetch_all_borrowed_item_rs($order_by, $sortorder, $start_index = NULL, $items_per_page = NULL) {
	$query = "SELECT bi.sequence_number, bi.item_id, bi.instance_no, bi.more_information, UNIX_TIMESTAMP(DATE_ADD(bi.update_on, INTERVAL bi.borrow_duration DAY)) as due_date, bi.borrower_id, i.s_item_type, i.title, ii.owner_id, ii.s_status_type " . "FROM item i, item_instance ii, borrowed_item bi "
			. "WHERE i.id = ii.item_id AND ii.instance_no = bi.instance_no AND bi.item_id = ii.item_id AND " . "bi.status = 'B' " . get_orderby_clause($order_by, $sortorder);
...
function fetch_my_borrowed_item_rs($borrower_id, $order_by, $sortorder, $start_index = NULL, $items_per_page = NULL) {
	$query = "SELECT bi.sequence_number, bi.item_id, bi.instance_no, bi.more_information, UNIX_TIMESTAMP(DATE_ADD(bi.update_on, INTERVAL bi.borrow_duration DAY)) as due_date, i.s_item_type, i.title, ii.owner_id, ii.s_status_type " . "FROM item i, item_instance ii, borrowed_item bi "
			. "WHERE i.id = ii.item_id AND ii.instance_no = bi.instance_no AND bi.item_id = ii.item_id AND " . "bi.status = 'B' and bi.borrower_id = '" . $borrower_id . "' " . get_orderby_clause($order_by, $sortorder);
...
function fetch_all_reserved_item_rs($order_by, $sortorder, $start_index = NULL, $items_per_page = NULL) {
	$query = "SELECT bi.sequence_number, bi.item_id, bi.instance_no, bi.borrower_id, bi.more_information, i.s_item_type, i.title, ii.owner_id, ii.borrow_duration, ii.s_status_type, UNIX_TIMESTAMP(bi.update_on) as reserve_date " . "FROM item i, item_instance ii, borrowed_item bi "
			. "WHERE i.id = ii.item_id AND ii.instance_no = bi.instance_no AND bi.item_id = ii.item_id AND " . "bi.status = 'R' " . get_orderby_clause($order_by, $sortorder);
...
function fetch_my_reserved_item_rs($borrower_id, $order_by = NULL, $sortorder = NULL, $start_index = NULL, $items_per_page = NULL) {
	$query = "SELECT bi.sequence_number, bi.item_id, bi.instance_no, i.s_item_type, i.title, ii.owner_id, bi.more_information, ii.borrow_duration, ii.s_status_type, UNIX_TIMESTAMP(bi.update_on) as reserve_date " . "FROM item i, item_instance ii, borrowed_item bi "
			. "WHERE i.id = ii.item_id AND ii.instance_no = bi.instance_no AND bi.item_id = ii.item_id AND " . "bi.status = 'R' and bi.borrower_id = '" . $borrower_id . "' ";
...
function fetch_my_basket_item_rs($borrower_id, $order_by, $sortorder, $start_index = NULL, $items_per_page = NULL) {
	$query = "SELECT bi.sequence_number, bi.item_id, bi.instance_no, i.s_item_type, bi.more_information, i.title, ii.owner_id, UNIX_TIMESTAMP(bi.update_on) as basket_date, bi.status, ii.s_status_type " . "FROM item i, item_instance ii, borrowed_item bi "
			. "WHERE i.id = ii.item_id AND bi.instance_no = ii.instance_no AND bi.item_id = ii.item_id AND " . " bi.status  = 'T' AND bi.borrower_id = '" . $borrower_id . "' " . get_orderby_clause($order_by, $sortorder);
...
function fetch_owner_reserved_item_rs($owner_id, $order_by = NULL, $sortorder = NULL, $start_index = NULL, $items_per_page = NULL) {
	$query = "SELECT bi.sequence_number, bi.item_id, bi.instance_no, i.s_item_type, bi.more_information, i.title, ii.borrow_duration, ii.s_status_type, bi.borrower_id, UNIX_TIMESTAMP(bi.update_on) as reserve_date " . "FROM item i, item_instance ii, borrowed_item bi "
...
function fetch_owner_borrowed_item_rs($owner_id, $order_by, $sortorder, $start_index = NULL, $items_per_page = NULL) {
	$query = "SELECT bi.sequence_number, bi.item_id, bi.instance_no, bi.more_information, UNIX_TIMESTAMP(DATE_ADD(bi.update_on, INTERVAL bi.borrow_duration DAY)) as due_date, i.s_item_type, i.title, ii.s_status_type, bi.borrower_id  " . "FROM item i, item_instance ii, borrowed_item bi "
			. "WHERE i.id = ii.item_id AND ii.instance_no = bi.instance_no AND bi.item_id = ii.item_id and " . "ii.owner_id = '" . $owner_id . "' and " . "bi.status = 'B' " . get_orderby_clause($order_by, $sortorder);
...
function fetch_reminder_borrowed_item_rs($duration_range) {
	$query = "SELECT bi.sequence_number, bi.item_id, bi.instance_no, bi.more_information, i.s_item_type, i.title, ii.s_status_type, bi.borrower_id, UNIX_TIMESTAMP(DATE_ADD(bi.update_on, INTERVAL bi.borrow_duration DAY)) as due_date, bi.borrow_duration, (TO_DAYS(now()) - TO_DAYS(bi.update_on)) as total_duration "
			. "FROM item i, item_instance ii, borrowed_item bi " . "WHERE i.id = ii.item_id AND " . "ii.instance_no = bi.instance_no AND " . "bi.item_id = ii.item_id AND " . "bi.status = 'B' AND " . "bi.borrow_duration > 0 AND "
