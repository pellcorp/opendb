...
function test_extension($extension) {
	$db_functions = array($extension . '_connect', $extension . '_select_db', $extension . '_error', $extension . '_errno', $extension . '_query', $extension . '_free_result', $extension . '_fetch_assoc', $extension . '_num_rows', $extension . '_num_fields', $extension . '_affected_rows');
